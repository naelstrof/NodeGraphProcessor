...
public class BaseGraphView : GraphView, IDisposable {
    ...
    private readonly Dictionary<Type, (Type nodeType, MethodInfo initalizeNodeFromObject)> nodeTypePerCreateAssetType =
        new();
    ...
    private void InitGrid() {
        ...
        bgGrid.pickingMode = PickingMode.Ignore;
        Add(bgGrid);
    ...
    private void InitializeEdgeViews() {
        ...
        foreach (var serializedEdge in graph.edges) {
            ...
            edgeView.input =
                inputNodeView.GetPortViewFromFieldName(serializedEdge.inputFieldName,
