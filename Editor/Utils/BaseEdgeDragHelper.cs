...
public class BaseEdgeDragHelper : EdgeDragHelper {
    ...
    public bool HandleMouseDownEvent(Vector2 mousePosition) {
    ...
    public override void HandleMouseMove(MouseMoveEvent evt) => HandleMouseMoveEvent((VisualElement)evt.target, evt.mousePosition, evt.localMousePosition);
    public void HandleMouseMoveEvent(VisualElement ve, Vector2 mousePosition, Vector2 localMousePosition) {
        var gvMousePos = ve.ChangeCoordinatesTo(graphView.contentContainer, localMousePosition);
    ...
    public void HandleMouseUpEvent(Vector2 mousePosition) {
